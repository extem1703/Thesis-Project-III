...
with open('Cleantrigger_FC_45g_8H_1300_1.dat', 'r') as file1:
    lineas_archivo1 = file1.readlines()

# Leer el contenido del segundo archivo y almacenarlo en lineas_archivo2
with open('Cleantrigger_FC_45g_8H_1300_2.dat', 'r') as file2:
    lineas_archivo2 = file2.readlines()

with open('Cleantrigger_FC_45g_8H_1300_3.dat', 'r') as file3:
    lineas_archivo3 = file3.readlines()

with open('Cleantrigger_FC_45g_8H_1300_4.dat', 'r') as file4:
...
with open('Cleantrigger_FC_45g_8H_1300.dat', 'w') as file_salida:
